...
INSERT INTO public.portfolio_categories (name, slug, display_order, is_active) VALUES
('Landing', 'landing', 1, true),
('Corporate', 'corporate', 2, true),
('E-commerce', 'e-commerce', 3, true),
('SaaS', 'saas', 4, true),
('Mobile', 'mobile', 5, true),
('CRM', 'crm', 6, true);